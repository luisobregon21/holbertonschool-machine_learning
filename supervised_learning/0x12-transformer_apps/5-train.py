...
class LearningSchedule(tf.keras.optimizers.schedules.LearningRateSchedule):
    """
    Establish learning rate schedule for training transformer model, utilizes\
        given function for learning rate.
    ...
    def __call__(self, step):
        """Evaluate the learning rate for the given step."""
...
def train_transformer(N, dm, h, hidden, max_len, batch_size, epochs):
    """
    Create and trains a transformer for machine translation of Portuguese to\
        English using previously created dataset.
